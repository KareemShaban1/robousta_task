        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ Route('trips.update',$trip->id) }}" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bus_id" class="custom-select mr-sm-2">
                                        ...
                                        @foreach ($buses as $bus)
                                            <option value="{{ $bus->id }}" @selected($bus->id == $trip->bus_id)>{{ $bus->bus_number }}</option>
                                        @endforeach
                                    </select>
                                    @error('bus_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="start_station_id" class="custom-select mr-sm-2">
                                        ...
                                        @foreach ($stations as $station)
                                            <option value="{{ $station->id }}" @selected($station->id == $trip->start_station_id)>{{ $station->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                              <div class="form-group">
                                  ...
                                  <select name="end_station_id" class="custom-select mr-sm-2">
                                      ...
                                      @foreach ($stations as $station)
                                          <option value="{{ $station->id }}" @selected($station->id == $trip->end_station_id)>{{ $station->name }}</option>
                                      @endforeach
                                  </select>
                        ...
                        <div class="row">
                              <div class="col-md-6">
                                        <div class="form-group">
                                            <label> Trip Date <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control" type="date" value="{{$trip->trip_date}}" name="trip_date" >
                                            @error('trip_date')
